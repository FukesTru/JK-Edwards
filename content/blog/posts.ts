...
const allPosts: BlogPost[] = [
  {
    ...
    excerpt:
      "A dozen year-end moves — from reconciling your books to funding retirement and collecting W-9s — so your business starts tax season calm.",
    category: "Tax Tips",
    date: "2026-09-15",
    readMinutes: 4,
    image: "blog-year-end",
  ...
  },
  {
    ...
    excerpt:
      "Late deposits, misclassified workers and missed year-end forms are expensive. Here are the payroll mistakes we see most — and how to prevent them.",
    category: "Payroll",
    date: "2026-07-01",
    readMinutes: 4,
    image: "blog-payroll",
