...
const kinds = {
  price: { box: "border-gold/50 bg-gold/10", bar: "bg-gold" },
  info: { box: "border-line bg-paper", bar: "bg-navy" },
  warning: { box: "border-amber-300 bg-amber-50", bar: "bg-amber-500" },
};
