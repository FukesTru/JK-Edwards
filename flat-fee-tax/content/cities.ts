...
export const cities: City[] = [
  {
    ...
    slug: "peachtree-city",
    blurb: "Our home base, with in-person appointments or fully virtual service.",
  ...
  },
  {
    name: "Brooks",
    county: "Fayette County",
    blurb: "Rural southern Fayette County, with acreage, small farms and home businesses.",
  ...
  },
  {
    ...
    slug: "newnan",
    blurb: "Coweta’s county seat, with families, landlords and small-business owners.",
...
export const cityPages: CityPage[] = [
  {
    ...
    intro: [
      ...
      "Tax offices often price that complexity one form at a time. We don’t. Your 1040 is one flat fee, with Schedules A, C and E, brokerage 1099-Bs and K-1s included. It’s prepared and signed by a licensed CPA and reviewed by an Enrolled Agent before anything is filed. You see the price before you book, and it doesn’t creep up when you mention the rental.",
    ...
    featured: {
      ...
      text: "Brokerage accounts, company stock and K-1 income are common here, and they’re all included.",
    },
    faqs: [
      {
  ...
  },
  {
    ...
    intro: [
      ...
      "Schedule C is exactly where that income belongs, and it’s included in our flat fee. We help you capture legitimate business expenses like equipment, software, supplies, business mileage and a qualifying home office, and we calculate your self-employment tax correctly. If you’re both a W-2 employee on one production and a contractor on another, we handle both on the same return for the same price.",
    ...
    highlights: [
      ...
      },
      {
        ...
        text: "Staff roles and contract gigs combined on one return, with no per-form add-ons.",
      },
      {
    ...
    featured: {
      ...
      text: "Freelance and 1099 income, home office, mileage and self-employment tax are all included.",
    },
    faqs: [
      {
  ...
  },
  {
    ...
    featured: {
      ...
      text: "Rental income, expenses and depreciation for Newnan landlords, all included in the flat fee.",
    },
    faqs: [
      {
  ...
  },
  {
    ...
    intro: [
      ...
      "What does change is who looks at your return. Every return we prepare is prepared and signed by a licensed CPA and reviewed by an Enrolled Agent. That’s two licensed professionals on every return, every year. If the IRS ever sends a letter about a prior year, our flat-fee tax resolution service is here for that too.",
      "Tyrone is also a place where people quietly start businesses from home, like consulting, contracting or online shops. When that side income shows up for the first time, Schedule C and self-employment tax can come as a surprise. We’ll show you what to track during the year and how to set aside estimated payments, so the following return is smoother.",
    ],
    highlights: [
      {
    ...
    faqs: [
      {
        ...
        a: "Our office is in Peachtree City, just a short drive south of Tyrone. Use the map on this page for directions, or work with us online.",
      },
      {
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Yes. Upload documents securely, review your return and e-sign, with no drive required. Or meet us in Peachtree City. [Here’s how it works](/how-it-works).",
      },
    ],
...
export const smallTownNotes: { name: string; county: City["county"]; text: string }[] = [
  {
    name: "Brooks",
    county: "Fayette County",
    text: "In rural southern Fayette County, Brooks households often combine W-2 jobs with acreage, small farms, horse properties or a business run from home. We prepare those returns for the same flat fee, including Schedule C for side businesses and Schedule E for any property you rent out. Our Peachtree City office is an easy drive up the road.",
  },
  {
    name: "Sharpsburg",
    county: "Coweta County",
    text: "Sharpsburg sits between Newnan and Peachtree City, so plenty of residents commute in both directions. Families here get the same flat-fee return with Schedule A, C and E, 1099-Bs and K-1s included, prepared and signed by a CPA and reviewed by an Enrolled Agent, whether in person in Peachtree City or entirely online.",
  },
];
